...
void PrintBestSolution(string BestIndividual[], int SequenceLength, int GA[3][3], int Target_Goal[3][3])
{
	cout << "\n--- Best Solution ---\n";
	...
	cout << "Fitness:" << Fitness(BestIndividual, SequenceLength, GA, Target_Goal);
...
int main()
{
	...
	PrintBestSolution(BestSol, Length, GA, Target_Goal);
